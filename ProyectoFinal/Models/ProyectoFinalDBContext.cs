...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DUPAINCHENG;Initial Catalog=ProyectoFinalDB;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cita1>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCentroVacunacionNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CITA1__id_centro__5070F446");

                entity.HasOne(d => d.IdGestorNavigation)
                    .WithMany(p => p.Cita1s)
                    .HasForeignKey(d => d.IdGestor)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CITA1__id_gestor__4E88ABD4");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.Cita1s)
                    .HasForeignKey(d => d.IdUsuario)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CITA1__id_usuari__4F7CD00D");
            });
            ...
            modelBuilder.Entity<Cita2>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCentroVacunacionNavigation)
                    ...
                    .HasForeignKey(d => d.IdCentroVacunacion)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CITA2__id_centro__534D60F1");

                entity.HasOne(d => d.IdGestorNavigation)
                    .WithMany(p => p.Cita2s)
                    .HasForeignKey(d => d.IdGestor)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CITA2__id_gestor__5165187F");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.Cita2s)
                    .HasForeignKey(d => d.IdUsuario)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CITA2__id_usuari__52593CB8");
            });
